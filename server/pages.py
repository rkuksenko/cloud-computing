...
<body style="background-color:#CECECE;">
  <h1>Hello Aleksandr Kurochkin!</h1>
  <hr>
  ...
  <p>To see amount of active threads (tasks) use <a href="http://35.238.215.222/get-active-task-number"><b>http://35.238.215.222/get-active-task-number</b></a></p>
